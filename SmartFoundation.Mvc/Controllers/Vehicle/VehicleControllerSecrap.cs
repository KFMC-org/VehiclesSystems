...
namespace SmartFoundation.Mvc.Controllers.VIC
{
    ...
    {
        public async Task<IActionResult> Scrap_List(
              string? scrapID = null
            ...
            try
            {
                ...
                if (dataTable != null && dataTable.Columns.Count > 0)
                {
                    ...
                    foreach (DataRow r in dataTable.Rows)
                    {
                        ...
                        dict["p03"] = NormalizeDateForInput(Get("ScrapDate"));
                        ...
                        dict["p08"] = Get("Notes");
                        dict["p09"] = Get("Status");
                        dict["p10"] = approvedDateNormalized;
                        dict["p11"] = dict["plateDisplay"];
                ...
                {
                    new FieldConfig { Name = "pageName_", Type = "hidden", Value = "Scrap_Upsert" },
                ...
                {
                    new FieldConfig { Name = "pageName_", Type = "hidden", Value = "Scrap_Action" },
                    new FieldConfig { Name = "ActionType", Type = "hidden", Value = "APPROVE" },
                    new FieldConfig { Name = "idaraID", Type = "hidden", Value = IdaraId },
                    new FieldConfig { Name = "entrydata", Type = "hidden", Value = usersId },
                    new FieldConfig { Name = "hostname", Type = "hidden", Value = HostName },
                    new FieldConfig { Name = "redirectUrl", Type = "hidden", Value = currentUrl },
                ...
                {
                    new FieldConfig { Name = "pageName_", Type = "hidden", Value = "Scrap_Action" },
                    new FieldConfig { Name = "ActionType", Type = "hidden", Value = "CANCEL" },
                    new FieldConfig { Name = "idaraID", Type = "hidden", Value = IdaraId },
                    new FieldConfig { Name = "entrydata", Type = "hidden", Value = usersId },
                    new FieldConfig { Name = "hostname", Type = "hidden", Value = HostName },
                    new FieldConfig { Name = "redirectUrl", Type = "hidden", Value = currentUrl },
...
var url = '/Vehicle/Scrap_List?scrapID=' + encodeURIComponent(id) + '&print=1';
